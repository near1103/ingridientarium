...
const Navbar = () => {
    ...
    console.log(process.env.REACT_APP_EDAMAM_APP_ID, process.env.REACT_APP_EDAMAM_API_KEY);
    ...
    return (
        <header className='w-full fixed z-10 bg-black opacity-90'>
            ...
            <div
                className={`${open ? "flex" : "hidden"} bg-black flex-col w-full px-4 pt-16 
                pb-10 text-white gap-6 text-[14px]`}>
                <a href="/">Home</a>
